...
export default function IskanFilter({ closeModel, setFilterData }) {
  ...
  return (
    ...
    >
      <LabelContainer
        label={
          wilaya ? `الولاية (${wilaya.wilaya_code}-${wilaya.wilaya_name})` : "الولاية"
        }
      >
        <CustomDropDown
      ...
      <LabelContainer label="ترتيب حسب">
        <CustomDropDown
          ...
          data={[
            { label: "تاريخ انطلاق المشروع", value: "start_date" },
