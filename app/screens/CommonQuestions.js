...
const faqData = [
  ...
  {
    question: "نحن جهة رسمية ومصرح لها بجمع التبرعات ونرغب بعرض فرص التبرع عبر المنصة. كيف يمكننا التواصل؟",
    answer: "نسعد بتواصلكم عبر البريد الإلكتروني [عنوان البريد الإلكتروني].",
  },
  {
