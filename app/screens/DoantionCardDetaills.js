...
const DonationCardDetails = ({ navigation, route }) => {
    ...
    >
      ...
      {data.progress && (
        <ProgressBar
          ...
          title={
            data.progress?.totalAmount + " " + process.env.APP_CURRENCY_NAME
          }
        />
      )}
      ...
      >
        <RapportModal
          data={{
            name: "تقرير التبرع",
            rapportType: "donationOpportunityReport",
            URI: `${API_ENDPOINTS.REPPORTS.GET_DONATION_OPPORTUNITIES_REPPORTS}/${data.id}`,
          }}
        />
      </ModelWrapper>
    </ScreensContainer>
