...
const API_ENDPOINTS = {
  ...
  CONVERT_AMBASADOR_POINTS: `${BASE_URL}/convert-ambasador-points`,
  ...
  DASHBOARDS: {
    ...
    confirmInvoice: `${BASE_URL}/dashboards/charity/confirm-order-receipt`,

    //SUPPLIERS
    SUPPLIERS: `${BASE_URL}/dashboards/suppliers/`,
  },
  ...
  STORE: {
    ...
    GET_MY_PRODUCTS: `${BASE_URL}/store/products/my-products`, // Get MY products
  ...
  DONATION_OPERTUNITIES: {
    ...
    GET_MY_ALL: `${BASE_URL}/donation-opportunities/my`, // Get all donation opportunities
