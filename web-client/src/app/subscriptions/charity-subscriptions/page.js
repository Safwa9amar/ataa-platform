        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col gap-3">
            <span className="text-xl font-semibold text-gray-700 dark:text-gray-300">
              اسم الجمعية: {user?.charity?.legalName}
            </span>
            <span className="mt-4 text-gray-600 dark:text-gray-400">
              المدة المتبقية في الاشتراك الحالي:{" "}
              {dayjs(subscriptions?.[0]?.endDate).diff(dayjs(), "days")} يوم
            </span>
          </div>
          <img
            src={user?.charity?.logo || "/logo/fullLogo.png"}
            className="w-40"
          />
        </div>
      </section>
                ...
                >
                  ...
                  <td className="border border-gray-300 dark:border-gray-600 p-2">
                    <div className="mt-4 text-gray-600 dark:text-gray-400">
                      نم الدفع بواسطة :{subscription.paymentMethod}
                    </div>
                  </td>
