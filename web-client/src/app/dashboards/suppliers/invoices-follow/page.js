    ...
    <div className="container mx-auto">
      <div className="flex flex-wrap justify-between my-5">
        <div className="flex items-center gap-5">
          ...
          />
          <Link
            className="text-sm border border-teal-700 text-teal-700 hover:text-white text-center p-2 hover:bg-teal-700 transition-all w-52 rounded-full "
            href={"invoices-follow/create"}
          >
            انشاء فاتورة
          </Link>
        </div>
