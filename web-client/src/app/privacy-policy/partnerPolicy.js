const supplierPrivacyPolicySections = [
  {
    title: "البند 1: مقدمة",
    description:
  ...
  },
  {
    ...
    description:
      ...
      "+ البيانات الخاصة بالمورد أو التاجر أثناء عملية التسجيل.\n" +
      "+ تفاصيل المنتجات والخدمات المقدمة.\n" +
      ...
      "+ أي بيانات يدخلها المورد أو التاجر عند استخدام المنصة.",
  },
  {
    title: "البند 3: جمع البيانات وتخزينها",
    description:
      "+ جمع البيانات: يوافق المورد أو التاجر على جمع بياناته عند التسجيل أو أثناء استخدام المنصة.\n" +
      "+ تخزين البيانات: يتم تخزين البيانات على خوادم آمنة داخل الجزائر.\n" +
      "+ حذف البيانات: يمكن للمورد أو التاجر طلب حذف بياناته عبر الدعم الفني، وسيتم تحويل الحساب إلى وضع غير نشط مع إخفاء أي محتوى مرتبط.",
  },
  {
    title: "البند 4: الاستخدام والإفصاح عن البيانات",
    description:
      "+ يوافق المورد أو التاجر على استخدام البيانات للإحصائيات وتحسين خدمات المنصة.\n" +
      "+ يوافق المورد أو التاجر على السماح لمنصة عطاء، بما في ذلك الأشخاص المخولين من موظفيها والعاملين فيها، بالوصول إلى بياناتها.\n" +
      "+ يقر المورد أو التاجر بعلمه بأن لمنصة عطاء الحق في كشف أي معلومات للجهات المختصة، عندما يكون ذلك ضرورياً للالتزام بأي قانون أو نظام أو طلب حكومي أو قضائي.",
  },
  {
...
export default supplierPrivacyPolicySections;
