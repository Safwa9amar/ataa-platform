const privacyPolicySections = [
  ...
  },
  {
    ...
    description:
      ...
      "+ البيانات الخاصة بالجمعية أثناء عملية التسجيل\n" +
      "+ معلومات الدفع والاشتراكات في الباقات\n" +
      ...
      "+ أي بيانات تُدخلها الجمعية عند استخدام المنصة.",
  },
  {
    title: "البند 3: جمع البيانات وتخزينها",
    description:
      "+ جمع البيانات: توافق الجمعيات على جمع بياناتها عند التسجيل أو أثناء استخدام المنصة.\n" +
      "+ تخزين البيانات: يتم تخزين البيانات على خوادم آمنة داخل الجزائر.\n" +
      "+ حذف البيانات: يمكن للجمعية طلب حذف بياناتها عبر الدعم الفني، وسيتم تحويل الحساب إلى وضع غير نشط مع إخفاء أي محتوى مرتبط.",
  },
  {
    title: "البند 4: الاستخدام والإفصاح عن البيانات",
    description:
      "+ توافق الجمعية على استخدام البيانات للإحصائيات وتحسين خدمات المنصة.\n" +
      "+ توافق الجمعية على السماح لمنصة عطاء، بما في ذلك الأشخاص المخولين من موظفيها والعاملين فيها، بالوصول إلى بياناتها.\n" +
      "+ تقر الجمعية بعلمها بأن لمنصة عطاء الحق في كشف أي معلومات للجهات المختصة، عندما يكون ذلك ضرورياً للالتزام بأي قانون أو نظام أو طلب حكومي أو قضائي.",
  },
  {
